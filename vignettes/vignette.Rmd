...
In the followings examples, the REUTERS corpus included in the *polmineR* package will be used for demonstration purposes. It is a sampe of Reuters articles that is included in the tm package (cp. https://www.scss.tcd.ie/~luzs/t/cs4ll4/sw/reuters21578-xml/), and may already be known to some R users.
