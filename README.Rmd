...
Indexed sample corpora wrapped into R data packages can be installed from the [drat](https://cran.r-project.org/web/packages/drat/vignettes/DratFAQ.html)-repository
